...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/aluagandjj/Yash-music.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/CloudXSupport_channel")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Ananya_Paglu_Assistant")
